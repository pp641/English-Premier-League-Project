...
function Data8() {
    ...
    const getdata = async  () => {
        await axios.get("https://raw.githubusercontent.com/openfootball/football.json/master/2017-18/en.1.json")
    ...
    return (
        ...
        <div className="row justify-content-center" id ="2017-18">
