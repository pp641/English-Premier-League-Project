...
function Data3() {
    ...
    const getdata = async  () => {
        await axios.get("https://raw.githubusercontent.com/openfootball/football.json/master/2012-13/en.1.json")
    ...
    return (
        ...
        <div className="row justify-content-center" id ="2012-13">
