...
function Data10() {
    ...
    const getdata = async  () => {
        await axios.get("https://raw.githubusercontent.com/openfootball/football.json/master/2019-20/en.1.json")
    ...
    return (
        ...
        <div className =  "row justify-content-center" id ="2019-20">
