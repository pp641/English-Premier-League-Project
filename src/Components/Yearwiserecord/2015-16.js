...
function Data6() {
    ...
    const getdata = async  () => {
        await axios.get("https://raw.githubusercontent.com/openfootball/football.json/master/2015-16/en.1.json")
    ...
    return (
        ...
        <div className="row justify-content-center" id ="2015-16">
